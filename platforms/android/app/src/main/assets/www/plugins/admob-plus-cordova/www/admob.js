...
function canvasClick(e) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            for (i = 0, len = canvasBanners.length; i < len; i++) {
                canvas = canvasBanners[i];
                if (canvas.id == id) {
                    _canvas = canvas;
                    break;
                }
...
function updateCanvas() {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, width, height, i, len, canvas, rect, adViewImage, image, elapsed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    i = 0, len = canvasBanners.length;
                    _a.label = 1;
                case 1:
                    if (!(i < len)) return [3 /*break*/, 7];
                    canvas = canvasBanners[i];
                    if (!(!canvas.element.isConnected && canvas.autoDestroy)) return [3 /*break*/, 2];
                    canvas.this.destroy();
                    i--;
                    len--;
                    return [3 /*break*/, 6];
                case 2:
                    ...
                    if (!(rect.width === 0 && rect.height === 0)) return [3 /*break*/, 3];
                    canvas.this.hide();
                    return [3 /*break*/, 6];
                case 3:
                    canvas.this.show({
                    ...
                    if (!((rect.y + rect.height > 0 && rect.y < height) && (rect.x + rect.width > 0 && rect.x < width))) return [3 /*break*/, 6];
                    return [4 /*yield*/, canvas.this.getAdViewImage()];
                case 4:
                    adViewImage = _a.sent();
                    if (!adViewImage) return [3 /*break*/, 6];
...
function setCanvasInterval(drawInterval) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (drawInterval) {
